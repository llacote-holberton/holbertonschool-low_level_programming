...
/**
 * add_node_end - Adds a new "starting node" upon provided list.
...
list_t *add_node_end(list_t **head, const char *str)
{
	...
	;
	printf("\n\n\n === INSIDE ADD_NODE_END ===\n");
	printf("Last_node address is now %p.\n", (void *)last_node);
	/*
	 * last_node = *head;
	 * printf("Last_node address is now %p\n", (void *)last_node);
	 */
	...
	/* We add "at list's end" so logically next goes NULL to avoid dangling. */
	new_node->next = NULL;
	/* 3. Make the "link".         */
